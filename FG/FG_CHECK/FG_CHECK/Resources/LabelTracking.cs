    ...
    public class LabelTracking
    {
        ...
        public async Task<bool> doMD5Label(string LabelName, int PathIndex, bool isShowErrorMessage = false)
        {
            ...
            if (string.IsNullOrEmpty(wipMD5))
            {
                ...
                {
                    showMessage(string.Format("Not found MD5 of label file in db. " + Environment.NewLine
            ...
            if (!wipMD5.Equals(CurrentFileMD5))
            {
                ...
                if (isShowErrorMessage)
                {
                    showMessage(string.Format("Label file Version error. " + Environment.NewLine
        ...
        public async Task<bool> doLabelTracking_AddParamValue_1(Document doc, string LabelName, int PathIndex, DataTable paramTable, bool isShowErrorMessage = false)
        {
            ...
            if (flag != "11")
            {
                ...
                if (isShowErrorMessage)
                {
                    showMessage(LastErrorEng, LastErrorVN);
                }
                return false;
            }
        ...
        private void showMessage(string MessageEnglish, string MessageVietNam)
        {
            if (Form1.lang == "VNI")
            {
                System.Windows.Forms.MessageBox.Show(MessageVietNam);
            }
            else System.Windows.Forms.MessageBox.Show(MessageEnglish);
        }
    }
