...
namespace CHECK_MSL
{
    public class R107Service
    {
        ...
        public async Task<string> ExecCheckRouteProcedure(string line, string myGroup, string sn, SfcHttpClient sfcClient)
        {
            ...
            try
            {
                ...
                dt = await ExcuteSP("sfis1.NEW_CHECK_ROUTE", ListPara, sfcClient);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.ToString());
        ...
        public async Task<string> ExecR107Procedure(string line, string section, string myGroup, string station, string sn, string emp, SfcHttpClient sfcClient)
        {
            DataTable dt = null;
            try
            {
                ...
                ListPara = new List<SfcParameter>()
                            {
                                ...
                                new SfcParameter { Name = "mygroup", Value = myGroup, SfcParameterDataType = SfcParameterDataType.Varchar2, SfcParameterDirection = SfcParameterDirection.Input },
                                new SfcParameter { Name = "w_station", Value = "CHECK_MSL", SfcParameterDataType = SfcParameterDataType.Varchar2, SfcParameterDirection = SfcParameterDirection.Input },
                                ...
                                new SfcParameter { Name = "data", Value = sn, SfcParameterDataType = SfcParameterDataType.Varchar2, SfcParameterDirection = SfcParameterDirection.Input },
                                new SfcParameter { Name = "emp", Value = emp, SfcParameterDataType = SfcParameterDataType.Varchar2, SfcParameterDirection = SfcParameterDirection.Input },
                                new SfcParameter { Name = "res",  SfcParameterDataType = SfcParameterDataType.Varchar2, SfcParameterDirection = SfcParameterDirection.Output }
                            };

                dt = await ExcuteSP("sfis1.NEW_TEST_INPUT", ListPara, sfcClient);
            }
            catch (Exception ex)
            {
                throw new Exception(ex.ToString());
        ...
        //public static string ExecCreate856Procedure(string carrier, string trans, string hawb, string type, string area, string country, string dn, SfcHttpClient sfcClient)
        //{
        //    string result = null;
        //    try
        //    {
        ...
        //    string InEmpNo, string InMO, string InModel, string InVersion, string InRouteCode, string InTRSN, string InTraceCode, string InSN, string InLinkQty, SfcHttpClient sfcClient)
        //{
        //    string result = null;
        //    try
        //    {
        ...
        //public static string[] RunFailLocationErrorSnInput(string line, string group, string section, string station, string pcname, string emp, string location, string errorCode, string sn, SfcHttpClient sfcClient)
        //{
        //    string[] result = null;
        //    try
        //    {
        ...
        //    return result;
        //}
        //public static DataTable GetR107BySNERICSSON(string sn, SfcHttpClient sfcClient)
        //{
        //    DataTable dt = null;
        //    try
        //    {
        ...
        //public static DataTable GetR107BySN(string sn, SfcHttpClient sfcClient)
        //{
        //    DataTable dt = null;
        //    try
        //    {
        ...
        //public static DataTable GetR107SNInfoBySSN(string InSSN, SfcHttpClient sfcClient)
        //{
        //    DataTable dt = null;
        //    try
        //    {
        ...
        ////Get R107 Info By SN
        //public static DataTable GetR107SNInfoBySN(string InSN, SfcHttpClient sfcClient)
        //{
        //    DataTable dt = null;
        //    try
        //    {
        ...
        //public static DataTable GetR107ByIMEI(string IMEI, SfcHttpClient sfcClient)
        //{
        //    DataTable dt = null;
        //    try
        //    {
        ...
        public async Task< DataTable>  GetR107ByReelNo(string reelNo, SfcHttpClient  sfcClient)
        {
            DataTable dt = null;
            try
            {
        ...
        public async Task<DataTable> CheckLine(string Linename, SfcHttpClient sfcClient)
        {
            DataTable dt = null;
            try
            {
                string sql = string.Format(@"select distinct line_name from sfis1.C_LINE_DESC_T where line_name = '{0}' ", Linename);
        ...
        public async Task<DataTable> GetOverTimeMMinutesBySNandGroup(string InSN, string InGroup, SfcHttpClient sfcHttpClient)
        {
            ...
            try
            {
                string sql = string.Format(@" SELECT TRUNC( (SYSDATE- MAX(IN_STATION_TIME) )*24) AS OVER_MINUTES FROM SFISM4.R_SN_DETAIL_T WHERE SERIAL_NUMBER='{0}'  AND GROUP_NAME='{1}'  ", InSN, InGroup);
