...
namespace Make_Weight.Resource
{
    public class ResouceClass
    {
        ...
        public ResouceClass(MainWindow form)
        {
            this.MyForm = form;
        }
        ...
        public async Task<bool> Checkemp(string emp_no, string fun)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        setMessage("Excute procedure have error:" + "|" + _RESArray[0]);
                        return false;
                    }
                }
            }
            ...
            {
                setMessage("Call procedure have exceptions: " + ex.Message+"|"+ "Call procedure have exceptions: " + ex.Message);
                return false;
            }
        }
