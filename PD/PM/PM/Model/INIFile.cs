...
namespace PM.Model
{
    class INIFile
    {
        ...
        string filePath);
        [DllImport("kernel32")]
        private static extern int GetPrivateProfileString_Other(string section,
        string key,
        string other,
        string def,
        StringBuilder retVal,
        ...
        public string ReadString(string section, string key,string other)
        {
            StringBuilder SB = new StringBuilder(255);
            int i = GetPrivateProfileString_Other(section, key,other, "", SB, 255, this.filePath);
            return SB.ToString();
        }
